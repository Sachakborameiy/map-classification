...
const MapAPIs: NextPage<MapAPIProps> = (props) => {
  ...
  useEffect(() => {
    ...
    const generateIframeCode = () => {
      ...
      // const code = `<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3963.286504980551!2d${longitude}!3d${latitude}!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47e66e1f06e2b70f%3A0x40b82c3688c9460!2sEiffel%20Tower!5e0!3m2!1sen!2sfr!4v1631947602489!5m2!1sen!2sfr&amp;t=k" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>`;

      const code = `
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3963.286504980551!2d${longitude}!3d${latitude}!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47e66e1f06e2b70f%3A0x40b82c3688c9460!2sEiffel%20Tower!5e0!3m2!1sen!2sfr!4v1631947602489!5m2!1sen!2sfr&amp;t=k" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
  ...
  const [copiedIframe, setCopiedIframe] = useState("");
  const handlePaste = () => {
    // Implement logic to handle paste action
    navigator.clipboard.readText().then((copiedText) => {
      setCopiedIframe(copiedText);
    });
  };
